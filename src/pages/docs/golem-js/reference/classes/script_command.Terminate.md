...
[src/script/command.ts:106](https://github.com/golemfactory/golem-js/blob/2d598a3/src/script/command.ts#L106)
...
[src/script/command.ts:38](https://github.com/golemfactory/golem-js/blob/2d598a3/src/script/command.ts#L38)
...
[src/script/command.ts:53](https://github.com/golemfactory/golem-js/blob/2d598a3/src/script/command.ts#L53)
