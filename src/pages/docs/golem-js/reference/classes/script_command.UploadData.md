...
[src/script/command.ts:151](https://github.com/golemfactory/golem-js/blob/f1546de/src/script/command.ts#L151)
...
[src/script/command.ts:160](https://github.com/golemfactory/golem-js/blob/f1546de/src/script/command.ts#L160)
...
[src/script/command.ts:164](https://github.com/golemfactory/golem-js/blob/f1546de/src/script/command.ts#L164)
