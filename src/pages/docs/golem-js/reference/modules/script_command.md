...
[src/script/command.ts:76](https://github.com/golemfactory/golem-js/blob/a42794e/src/script/command.ts#L76)
...
[src/script/command.ts:80](https://github.com/golemfactory/golem-js/blob/a42794e/src/script/command.ts#L80)
