...
[src/script/command.ts:76](https://github.com/golemfactory/golem-js/blob/c332187/src/script/command.ts#L76)
...
[src/script/command.ts:80](https://github.com/golemfactory/golem-js/blob/c332187/src/script/command.ts#L80)
