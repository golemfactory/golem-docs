...
{% alert level="warning" %}
Before removing Yagna, please make sure you have backed up your private key. You can find the instructions [here](/docs/en/creators/tools/yagna/golem-wallet-backup).
{% /alert %}
...
- If you are looking for intructions for Providers see [here](/docs/en/providers/provider-uninstallation).
