...
and the [mainnet](/docs/en/creators/ray/mainnet).
...
There is also an image supporting Golem GPU Providers - learn more about [image configuration](/docs/en/creators/ray/cluster-yaml#image-tag-and-image-hash).
...
you can use `pip` via [cluster yaml `initialization_commands`](/docs/en/creators/ray/cluster-yaml#initializationcommands)
...
It is demonstrated for example in [this tutorial](/docs/en/creators/ray/conversion-to-ray-on-golem-tutorial#passendplaylibraryrequirementtoray).
