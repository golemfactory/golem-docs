...
You can read more about outbound feature [here](/docs/en/creators/javascript/guides/accessing-internet).
...
- More on the [Payload Manifest](/docs/en/golem/payload-manifest)
