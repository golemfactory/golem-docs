...
The payments are made with Golem Network's native ERC-20 token, [GLM](https://etherscan.io/token/0x7DD9c5Cba05E151C895FDe1CF355C9A1D5DA6429), using either the Ethereum Mainnet directly or, preferably, one of the [Layer 2 solutions](/docs/en/golem/payments/layer-2-payments).
...
- [Layer 2 payments](/docs/en/golem/payments/layer-2-payments)
