...
**Provider** is a node that is sharing its temporarily unused computer resources for Requestors within the Golem Network in return for [GLM](/docs/golem/overview/golem-token) tokens.
