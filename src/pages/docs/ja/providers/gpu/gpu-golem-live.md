...
3.  **Terms of Use Acceptance** - select `YES` to confirm the terms of use. You can read the whole thing at your convenience at: [https://docs.golem.network/docs/ja/golem/terms](https://docs.golem.network/docs/ja/golem/terms)
