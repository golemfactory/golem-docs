...
It allows Ray to distinguish `submit` arguments from the script ones ([more details](/docs/ja/creators/ray/troubleshooting#passing-arguments-to-your-ray-script-fails)).
