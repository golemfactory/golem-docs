...
Check out more details about Ray on Golem [stopping and starting](/docs/ja/creators/ray/ray-on-golem-cli#ray-on-golem-start-stop).
...
Check out the [cluster yaml](/docs/ja/creators/ray/cluster-yaml#initialization-commands) article to get more information.
...
Checkout [the logs](/docs/ja/creators/ray/troubleshooting#ray-on-golem-s-log-files) to see what happened.
...
If you see nothing interesting in the logs, you might want to [start over](/docs/ja/creators/ray/troubleshooting#starting-over-with-a-clean-slate).
