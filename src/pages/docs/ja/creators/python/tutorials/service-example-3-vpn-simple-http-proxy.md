...
In the example code, we're already using a pre-built and pre-uploaded Golem VM image but if you'd like to experiment with other HTTP servers or web-based applications, please follow our guides on the preparation of your own VM [images for Golem](/docs/ja/creators/python/tutorials/building-custom-image).
...
- The next article takes a close look at [custom usage counters](/docs/ja/creators/python/tutorials/service-example-4-custom-usage-counters) example.
