...
- Gvmkit-build. ([Installation instructions](/docs/ja/creators/tools/gvmkit/gvmkit-build-installation))
- Yagna running with `try_golem` app-key configured ([see instructions](/docs/ja/creators/tools/yagna/yagna-installation-for-requestors))
...
If you do not have `gvmkit-build` installed, please follow the [installation intructions](/docs/ja/creators/tools/gvmkit/gvmkit-build-installation). You can also use it without installation, by using `pipx`.
...
- Try your image in one of [tutorials](/docs/ja/creators/python/tutorials)!
