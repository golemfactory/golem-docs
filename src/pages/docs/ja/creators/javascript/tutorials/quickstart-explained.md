...
This tutorial will utilize the same example found in [Quickstart](/docs/ja/creators/javascript/quickstarts/quickstart) and include thorough explanations.
...
We use api-key that was generated in the process of [Yagna installation](/docs/ja/creators/tools/yagna/yagna-installation-for-requestors)
...
There are other methods that allow you to execute tasks. They are briefly presented in [Task API Guide](/docs/ja/creators/javascript/guides/task-model#main-task-api-features) and explained in [examples](/docs/ja/creators/javascript/examples) section.
