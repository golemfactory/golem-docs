...
See our [Create Golem Image Tutorial](/docs/ja/creators/javascript/tutorials/building-custom-image) on how to use the tool.
...
- Using the tag or hash in a requestor script. ([example](/docs/ja/creators/javascript/examples/working-with-images))
...
- [Creating custom Golem Image](/docs/ja/creators/javascript/tutorials/building-custom-image) Step-by-step tutorial
- [Golem Images FAQ](/docs/ja/creators/javascript/guides/golem-images-faq)
