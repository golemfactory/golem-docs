...
Inside each task function we employed the `beginBatch()` to chain multiple commands - you can see more about this feature in the [Defining Tasks](/docs/ja/creators/javascript/examples/composing-tasks) article.
