...
Before you get started, make sure you have installed [yagna](/docs/ja/creators/tools/yagna/yagna-installation-for-requestors) and [created an app-key](/docs/ja/creators/javascript/examples/using-app-keys#creating-unique-app-keys)
...
This provides context for the rest of the SDK. See the [YagnaProvider API reference](/docs/ja/creators/javascript/react/yagna-provider) for the list of all available configuration options.
...
To learn more about the SDK, check out the [API reference](/docs/ja/creators/javascript/react/api-reference-overview).

If you'd like to see the SDK in action before you start using it, check out the [example application](/docs/ja/creators/javascript/react/#example-application).
