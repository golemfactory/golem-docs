...
{% alert level="info" %}
This section contains an extract from the Golem Network documentation for Degen Hack hackathon participants. The full version is available on the [Golem Docs portal](https://docs.golem.network/) and specifically JS related documentation can be found [here](https://docs.golem.network/docs/ja/creators/javascript).
...
Make sure you have created an app-key and exported its value as [`YAGNA_APPKEY`](http://localhost:3000/docs/ja/degen#creating-a-unique-app-key).
...
You can find an explanation of the structure of the typical requestor script [here](/docs/ja/creators/javascript/tutorials/quickstart-explained).
