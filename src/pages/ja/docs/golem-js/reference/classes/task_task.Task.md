...
[src/task/task.ts:72](https://github.com/golemfactory/golem-js/blob/4182943/src/task/task.ts#L72)
...
[src/task/task.ts:104](https://github.com/golemfactory/golem-js/blob/4182943/src/task/task.ts#L104)
