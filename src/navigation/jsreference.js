    ...
    links: [
      {
        ...
        href: '/docs/yajsapi/reference/support-new-docs/overview',
      },
      {
        title: 'classes',
        children: [
        ...
        children: [
          {
            ...
            href: '/docs/yajsapi/reference/support-new-docs/modules/activity_results',
          },
          {
            title: 'Agreement_service',
            href: '/docs/yajsapi/reference/support-new-docs/modules/agreement_service',
          },
          {
            title: 'Agreement_strategy',
            href: '/docs/yajsapi/reference/support-new-docs/modules/agreement_strategy',
          },
          {
            title: 'Events_events',
            href: '/docs/yajsapi/reference/support-new-docs/modules/events_events',
          },
          {
            title: 'Executor_executor',
            href: '/docs/yajsapi/reference/support-new-docs/modules/executor_executor',
          },
          {
            title: 'Market_demand',
            href: '/docs/yajsapi/reference/support-new-docs/modules/market_demand',
          },
          {
            title: 'Market_proposal',
            href: '/docs/yajsapi/reference/support-new-docs/modules/market_proposal',
          },
          {
            title: 'Market_service',
            href: '/docs/yajsapi/reference/support-new-docs/modules/market_service',
          },
          {
            title: 'Market_strategy',
            href: '/docs/yajsapi/reference/support-new-docs/modules/market_strategy',
          },
          {
            title: 'Network_identity',
            href: '/docs/yajsapi/reference/support-new-docs/modules/network_identity',
          },
          {
            title: 'Network_network',
            href: '/docs/yajsapi/reference/support-new-docs/modules/network_network',
          },
          {
            title: 'Network_node',
            href: '/docs/yajsapi/reference/support-new-docs/modules/network_node',
          },
          {
            title: 'Package_package',
            href: '/docs/yajsapi/reference/support-new-docs/modules/package_package',
          },
          {
            title: 'Package_repo_resolver',
            href: '/docs/yajsapi/reference/support-new-docs/modules/package_repo_resolver',
          },
          {
            title: 'Payment_config',
            href: '/docs/yajsapi/reference/support-new-docs/modules/payment_config',
          },
          {
            title: 'Payment_debit_note',
            href: '/docs/yajsapi/reference/support-new-docs/modules/payment_debit_note',
          },
          {
            title: 'Payment_invoice',
            href: '/docs/yajsapi/reference/support-new-docs/modules/payment_invoice',
          },
          {
            title: 'Payment_payments',
            href: '/docs/yajsapi/reference/support-new-docs/modules/payment_payments',
          },
          {
            title: 'Payment_service',
            href: '/docs/yajsapi/reference/support-new-docs/modules/payment_service',
          },
          {
            title: 'Payment_strategy',
            href: '/docs/yajsapi/reference/support-new-docs/modules/payment_strategy',
          },
          {
            title: 'Script_command',
            href: '/docs/yajsapi/reference/support-new-docs/modules/script_command',
          },
          {
            title: 'Storage_gftp',
            href: '/docs/yajsapi/reference/support-new-docs/modules/storage_gftp',
          },
          {
            title: 'Storage_provider',
            href: '/docs/yajsapi/reference/support-new-docs/modules/storage_provider',
          },
          {
            title: 'Task_batch',
            href: '/docs/yajsapi/reference/support-new-docs/modules/task_batch',
          },
          {
            title: 'Task_service',
            href: '/docs/yajsapi/reference/support-new-docs/modules/task_service',
          },
          {
            title: 'Task_task',
            href: '/docs/yajsapi/reference/support-new-docs/modules/task_task',
          },
          {
            title: 'Task_work',
            href: '/docs/yajsapi/reference/support-new-docs/modules/task_work',
          },
          {
            title: 'Utils_env',
            href: '/docs/yajsapi/reference/support-new-docs/modules/utils_env',
          },
          {
            title: 'Utils_logger_consoleLogger',
            href: '/docs/yajsapi/reference/support-new-docs/modules/utils_logger_consoleLogger',
          },
          {
            title: 'Utils_logger_defaultLogger',
            href: '/docs/yajsapi/reference/support-new-docs/modules/utils_logger_defaultLogger',
          },
          {
            title: 'Utils_logger_jsonLogger',
            href: '/docs/yajsapi/reference/support-new-docs/modules/utils_logger_jsonLogger',
          },
          {
            title: 'Utils_logger_logger',
            href: '/docs/yajsapi/reference/support-new-docs/modules/utils_logger_logger',
          },
          {
            title: 'Utils_logger_nullLogger',
            href: '/docs/yajsapi/reference/support-new-docs/modules/utils_logger_nullLogger',
          },
          {
            title: 'Utils_logger_pinoLogger',
            href: '/docs/yajsapi/reference/support-new-docs/modules/utils_logger_pinoLogger',
          },
          {
            title: 'Utils_runtimeContextChecker',
            href: '/docs/yajsapi/reference/support-new-docs/modules/utils_runtimeContextChecker',
          },
          {
            title: 'Utils_types',
            href: '/docs/yajsapi/reference/support-new-docs/modules/utils_types',
          },
        ],
      },
    ],
