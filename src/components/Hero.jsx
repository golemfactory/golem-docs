...
export function Hero() {
  return (
    <div className="relative mx-auto mt-10 flex max-w-8xl sm:px-2 lg:px-8 xl:px-12">
      <div className="w-full rounded-lg bg-lightblue px-4 py-12 text-center dark:bg-darkcontent md:text-left lg:px-16">
            ...
            <div className="mt-8 grid gap-y-2 md:flex md:gap-x-2">
              <div className="flex gap-x-2">
                <div className="text-center">
                  <a
                    href="/docs"
                    className="flex items-center rounded bg-primary px-2 py-2 text-white hover:bg-blue-600 dark:bg-darkprimary dark:hover:bg-darkprimary/80"
                  >
                ...
                <div className="group relative inline-flex">
                  <span className="inline-flex items-center rounded bg-lightergray px-2 py-1 text-white dark:bg-disabledgray">
