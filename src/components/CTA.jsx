    ...
    <div className="not-prose relative w-full rounded-lg bg-lightblue px-4 pb-20 pt-16 dark:bg-darkcontent">
      ...
      <div className="relative grid gap-y-4 md:grid-cols-2 md:gap-y-4">
        ...
        <div className="first-letter: z-30 grid items-center gap-y-4 px-12 ">
          ...
          <p className="text-base-design text-normalgray dark:text-white dark:opacity-50">
            {description}
          </p>
          <div className=" mt-4 flex">
            <Link
              href={href}
              className="text-base-design flex h-full items-center rounded bg-primary px-4 py-2 font-medium text-white hover:bg-primary/80 dark:bg-darkprimary dark:hover:bg-darkprimary/80"
            >
